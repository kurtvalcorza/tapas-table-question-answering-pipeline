"""Static release-asset validation for the TAPAS-large WTQ table question answering DIMER pipeline.
...
EXPECTED_MODEL_ID = "google/tapas-large-finetuned-wtq"
...
# Additional 40-hex revisions a document may legitimately cite: the pinned WikiSQL parquet revision.
KNOWN_SHAS: frozenset[str] = frozenset(("48cfb60afd0d5f9d2231ca90f76edf9f975181bc",))
...
EXPECTED_OUTPUTS = (
    "outputs/tapas_table_qa_train.jsonl",
    "outputs/tapas_table_qa_input_manifest.json",
    "outputs/tapas_table_qa_evaluation_report.json",
    "outputs/tapas_table_qa_answers.csv",
    "outputs/tapas_table_qa_adapter",
    "outputs/tapas_table_qa_result.json",
)
...
CODE_MARKERS = (
    ...
    "ceilings = {'MAX_ROWS': MAX_ROWS, 'MAX_COLUMNS': MAX_COLUMNS, 'MAX_TOKENS': MAX_TOKENS, 'MAX_QUERY_CHARS': MAX_QUERY_CHARS, 'MAX_CELL_CHARS': MAX_CELL_CHARS, 'AGGREGATIONS': AGGREGATIONS, 'CELL_THRESHOLD': CELL_THRESHOLD, 'MIN_RECORDS': MIN_RECORDS, 'MAX_RECORDS': MAX_RECORDS",
    ...
    "frozen_scene = evaluation_report(frozen_rows, golds, sample_kind=",
    ...
    "adapted_scene = evaluation_report(adapted_rows, golds, sample_kind=",
...
MARKDOWN_MARKERS = (
    "**Capability:** table question answering (one table of string cells + one question → selected cells, one aggregation operator NONE/SUM/AVERAGE/COUNT, and a pipeline-computed numeric answer) and bounded supervised fine-tuning",
    "**Apache-2.0** licence",
    "**the numeric answer is the pipeline's arithmetic over the selected cell strings**, never a model output",
    "**every question yields some cells and some operator**",
    "**adaptation with labelled questions**",
    "**BSD-3-Clause**",
    ...
    "**Snapshot note:**",
    "conversational or multi-turn table QA (the SQA setting)",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    3_630_670: "Salesforce/wikisql@48cfb60 default/validation/0000.parquet (dataset)",
    100_798_688: "adapter.safetensors from save_artifact (default two blocks)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "806362262fe311efd659049821f857946ad7f4188385172f9c3d0411e919463e": "SAMPLE_DIGEST: dataset_digest of the default seeded WikiSQL draw",
    "ed524cc7221e6c0010c7b57691da40897b38dce65090ecff48836989d606a347": "Salesforce/wikisql@48cfb60 default/validation/0000.parquet (dataset)",
}
